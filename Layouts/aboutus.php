...
<nav class="navbar navbar-default">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">About Us</a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <!--
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="FirstHomePage.html">Home Page</a> </li>
        <li><a href="Login-Signup/Login_Register.php">Login / Sign Up</a> </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <p class="text-center">We are a web application for Syracuse University students to   generate their own class schedule according to the preferences they have. We allow users to search for class information they need/want to take for a particular school semester. Class Scheduler has a list of classes that fulfill the user's requests. 
               Users can also select a certain time period that they do not want classes to be scheduled so that it will help the Class Scheduler to generate a class schedule that does not have conflict with users’ life schedule. 
           Class Scheduler will generate all possible class schedules that meet the user's’ requests and preferences. The users can save the schedule(s) they want and login to MySlice, start enrolling classes. </p>
          <p>&nbsp;</p>
          <p class="text-center"><a class="btn btn-primary btn-lg" href="Login-Signup/signup.php" role="button">Get Started Now!</a> </p>
        </div>
      </div>
    </div>
  </div>
